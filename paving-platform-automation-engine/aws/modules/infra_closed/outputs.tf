...
output "egress_only_route_table_ids" {
  value = aws_route_table.egress_only.*.id
}
...
output "closed_subnet_ids" {
  value = aws_subnet.closed_subnets.*.id
}

output "closed_subnet_availability_zones" {
  value = aws_subnet.closed_subnets.*.availability_zone
}

output "closed_subnet_cidrs" {
  value = aws_subnet.closed_subnets.*.cidr_block
}

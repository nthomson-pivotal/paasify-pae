...
output "closed_subnet_ids" {
  value = module.infra.closed_subnet_ids
}
...
output "closed_subnet_availability_zones" {
  value = module.infra.closed_subnet_availability_zones
}

output "closed_subnet_cidrs" {
  value = module.infra.closed_subnet_cidrs
}
...
output "aws_lb_interface_endpoint_ips" {
  value = module.vpc_endpoint.aws_lb_interface_endpoint_ips
}

output "aws_ec2_interface_endpoint_ips" {
  value = module.vpc_endpoint.aws_ec2_interface_endpoint_ips
}
